...
* Promote the use of standardized requirements by users (e.g. projects using geospatial data) and producers
...
In particular, activities related with preparing data and processing data are welcome to contribute to this work. Examples are Analysis Ready Data (ARD) and OGC API Processes. Thematic groups that now the needs of their communities can also be useful contributors such as MetOcean.  
